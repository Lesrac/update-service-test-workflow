...
public class UpdateService : BackgroundService
{
        ...
        IHostApplicationLifetime hostLifetime)
    {
        ...
        _httpClient.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("CDRClientUpdateService", "1.0"));
        ...
        _logger.LogInformation("CDRClientUpdateService initialized. Installation path: {InstallationPath}, Service version: {Version}, Repository: {Repo}",
    ...
    {
        _logger.LogInformation("CDRClientUpdateService started. Check interval: {Interval} hours", _updateCheckInterval.TotalHours);
    ...
    {
        _logger.LogInformation("CDRClientUpdateService stopping");
        await base.StopAsync(cancellationToken);
        _httpClient.Dispose();
        _logger.LogInformation("CDRClientUpdateService stopped");
    }
    ...
    private async Task CheckAndApplyUpdates(CancellationToken cancellationToken)
    {
        try
        {
            ...
            _logger.LogDebug("Current versions - Service: {Service}, Watchdog: {Watchdog}, UpdateService: {Update}",
                ...
                _currentVersions.GetValueOrDefault("UpdateService", "unknown"));
    ...
    private async Task ApplyUpdates(GitHubRelease release, string newVersion, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("  UpdateService: {Version}",
                updatedComponents.Contains("UpdateService") ? newVersion : _currentVersions.GetValueOrDefault("UpdateService", "unknown"));
